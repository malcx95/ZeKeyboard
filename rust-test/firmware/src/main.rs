...
#[rtic::app(device = teensy4_bsp::ral, peripherals = false)]
mod app {
    ...
    const LPUART_POLL_INTERVAL_MS: u32 = board::UART_FREQUENCY / 1_000 * 100;
    ...
    /// uses `defmt`.
    const FRONTEND: bsp::logging::log = bsp::logging::log::Log;
